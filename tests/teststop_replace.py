...
def send_stop_replace_order(stop_order_id='39424', shares=19, stop_price=252.9):
    try:
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as client_socket:
            ...
            command = f'REPLACE {stop_order_id} {shares} STOPMKT {stop_price}'
