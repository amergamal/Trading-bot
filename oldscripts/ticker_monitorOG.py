...
class TickerMonitor:
    ...
    def handle_quote_data(self, quote_data):
        ...
        last_price = None
        vwap = None  # Initialize vwap variable
    ...
    def update_ldlu(self, ticker, limit_down, limit_up, timestamp):
        ...
        try:
            ...
            self.logger.warning(f"can't update LU value for {ticker} to {limit_up} at {timestamp}: {e}")
...
if __name__ == "__main__":
    ...
    try:
        ...
        if api_client.connected:
            ...
            monitor = TickerMonitor('EOD_data.db', api_client)
            monitor.run()
