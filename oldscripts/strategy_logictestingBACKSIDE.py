...
class StrategyLogic:
                ...
                try:
                    ...
                    if strategy_type in ["1MinBS", "5MinBS"]:
                        ...
                        if backside_signal:
                            ...
                            signal = self.generate_signal(row, ticker, strategy_type, vwap, stop_loss, trade_date)
    ...
    def run_ticker(self, ticker, strategy_type):
        ...
        strategies_1min = ['1MinBS']
        strategies_5min = ['5MinBS']
